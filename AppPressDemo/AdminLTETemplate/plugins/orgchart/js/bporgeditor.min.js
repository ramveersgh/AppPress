...
primitives.orgeditor.UserTemplateContact.prototype.getTemplate = function () {
    var a = new primitives.orgdiagram.TemplateConfig, c; a.name = this.name; a.itemSize = new primitives.common.Size(180, 120); a.minimizedItemSize = new primitives.common.Size(4, 4); a.highlightPadding = new primitives.common.Thickness(2, 2, 2, 2); c = jQuery('<div class="bp-item bp-corner-all bt-item-frame"><div name="titleBackground" class="bp-item bp-corner-all bp-title-frame" style="top: 2px; left: 2px; width: 176px; height: 20px;"><div name="title" class="bp-item bp-title" style="top: 3px; left: 6px; width: 168px; height: 18px;"></div></div><div class="bp-item bp-photo-frame" style="top: 26px; left: 2px; width:50px;"><img name="photo" style="width:48px; border:1px solid #cccccc;" /></div><div name="phone" class="bp-item" style="top: 26px; left: 56px; width: 122px; height: 18px; font-size: 12px;"></div><div name="email" class="bp-item" style="top: 44px; left: 56px; width: 122px; height: 18px; font-size: 12px;"></div><div name="description" class="bp-item" style="top: 62px; left: 56px; width: 122px; height: 36px; font-size: 10px;"></div><a name="readmorelabel" class="bp-item bp-readmore" style="top: 102px; left: 4px; width: 172px; height: 16px; font-size: 10px;"></a></div>').css({
        width: a.itemSize.width +
