    ...
    function Plugin (el, options) {
        ...
        base.init = function () {
            ...
            base.$el.each(function () {
                ...
                base.$clonedHeader.children().remove('.icheckbox_minimal-grey');
                base.$clonedHeader.children().children().remove('.icheckbox_minimal-grey');
                base.$clonedHeader.children().children().children().remove('.icheckbox_minimal-grey');
                base.$clonedHeader.children().children().children().children().remove('.icheckbox_minimal-grey');
        ...
        base.updateWidth = function () {
            ...
            if(base.$clonedHeader.width() > base.parentClientWidth)
            {
                ...
                var clipRight =  base.$container.outerWidth() + scrollLeft;
                base.$clonedHeader.css({
